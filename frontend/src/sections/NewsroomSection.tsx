      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div className="max-w-xl">
            <span className="font-mono-label text-[#FF4D2E] mb-4 block">PR NEWSROOM</span>
        ...
        <div className="divide-y divide-white/5">
          {newsItems.map((item, idx) => (
            <div key={idx} className="py-8 flex flex-col md:flex-row md:items-center justify-between group cursor-pointer hover:bg-white/[0.02] transition-colors -mx-6 px-6">
              <div className="flex-1">
                <div className="flex items-center gap-4 mb-3">
                  <span className="text-xs font-mono text-[#B8BDC7] opacity-60">{item.date}</span>
